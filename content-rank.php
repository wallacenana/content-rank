...
if (!defined('CONTENT_RANK_GENERATOR_UPDATE_MANIFEST_URL')) {
    define('CONTENT_RANK_GENERATOR_UPDATE_MANIFEST_URL', 'https://raw.githubusercontent.com/wallacenana/content-rank/main/update.json?v=1.9.62');
}
    ...
    final class Content_Rank_Generator
    {
        ...
        protected static function maybe_upgrade_generators_schema_columns()
        {
            ...
            $columns_to_check = array(
                ...
                'tmdb_composite_thumbnail_enabled' => array(
                    'definition' => 'tinyint(1) NOT NULL DEFAULT 0',
                    'after' => 'source_content_links_enabled',
                ),
            );
        ...
        public static function create_tables()
        {
            ...
            $sql_generators = "CREATE TABLE " . self::$table_generators . " (
                ...
                tmdb_composite_thumbnail_enabled tinyint(1) NOT NULL DEFAULT 0,
        ...
        public static function prepare_generator_record($generator)
        {
            ...
            $generator['source_content_links_enabled'] = isset($generator['source_content_links_enabled'])
                ...
                : (isset($generator['source_content_media_enabled']) ? (!empty($generator['source_content_media_enabled']) ? 1 : 0) : 1);
            $generator['tmdb_composite_thumbnail_enabled'] = !empty($generator['tmdb_composite_thumbnail_enabled']) ? 1 : 0;
        ...
        public static function bulk_build_manual_generator($list, $settings = array())
        {
            ...
            return array(
                ...
                'tmdb_composite_thumbnail_enabled' => !empty($settings['tmdb_composite_thumbnail_enabled']) ? 1 : 0,
        ...
        public static function create_post_from_generator_item($generator, $item, $prepared_article = null, $existing_post_id = 0)
        {
            ...
            $tmdb_composite_enabled = !empty($generator['tmdb_composite_thumbnail_enabled']) || (!empty($generator['image_source_mode']) && sanitize_key((string) $generator['image_source_mode']) === 'tmdb_composite');
            if (class_exists('Content_Rank_TMDB') && $tmdb_composite_enabled && !empty($item['tmdb_movies']) && is_array($item['tmdb_movies'])) {
                $composite_thumbnail_id = Content_Rank_TMDB::create_composite_thumbnail_for_post(
                    $post_id,
                    !empty($article['title']) ? $article['title'] : (!empty($item['title']) ? $item['title'] : 'tmdb-thumbnail'),
                    $item['tmdb_movies']
                );
                if (!is_wp_error($composite_thumbnail_id) && intval($composite_thumbnail_id) > 0) {
                    set_post_thumbnail($post_id, intval($composite_thumbnail_id));
                }
            }
        ...
        public static function save_generator($raw)
        {
            ...
            $data = array(
                ...
                'tmdb_composite_thumbnail_enabled' => $payload['tmdb_composite_thumbnail_enabled'],
        ...
        public static function duplicate_generator($id)
        {
            ...
            $duplicated = array(
                ...
                'tmdb_composite_thumbnail_enabled' => !empty($generator['tmdb_composite_thumbnail_enabled']) ? 1 : 0,
