...
if (!defined('CONTENT_RANK_GENERATOR_UPDATE_MANIFEST_URL')) {
    define('CONTENT_RANK_GENERATOR_UPDATE_MANIFEST_URL', 'https://raw.githubusercontent.com/wallacenana/content-rank/main/update.json?v=1.9.132');
}
    ...
    final class Content_Rank_Generator
    {
        ...
        public static function create_post_from_generator_item($generator, $item, $prepared_article = null, $existing_post_id = 0)
        {
            ...
            if ((!empty($tmdb_content_image_sections) || !empty($tmdb_content_video_sections)) && !empty($article['content_html'])) {
                if (!empty($tmdb_content_image_sections)) {
